...
<button type="button" style="float:right;margin-right:50px;margin-top:50px" onclick="window.location.href='login.jsp'"> LogIn / SignUp </button>
		<%}
			...
			<button type="button" style="float:right;margin-right:0px;margin-top:120px" onclick="window.location.href='logout.jsp'"> LogOut </button>
			...
			<button type="button" style="float:right;margin-right:0px" onclick="window.location.href='customerinfo.jsp'">Profile</button>
...
<%@page  import="java.sql.*"%>
	...
	<input type="button" value="Check Out" id="check" name="check" onclick="window.location.href='checkout.jsp'"/></div>
	<%}%><table border="1">
		<col width="300">
